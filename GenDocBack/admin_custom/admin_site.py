...
class CustomAdminSite(admin.AdminSite):
    ...
    """
    site_header = "GenDoc - Administration"
    ...
    def get_app_list(self, request, app_label=None):
        ...
        model_icons = {
            ...
            'group': 'fa-users',
            'permission': 'fa-key',
            'categorietemplate': 'fa-folder',
            'templatedocument': 'fa-file-word',
            'formulaire': 'fa-clipboard-list',
            'question': 'fa-question-circle',
            'choixquestion': 'fa-list',
            'typedocument': 'fa-file-alt',
            'documentgenere': 'fa-file-pdf',
            'reponsequestion': 'fa-comment-dots',
            'category': 'fa-tags',
            'template': 'fa-file-code',
            'templateversion': 'fa-code-branch',
            'dashboardgrid': 'fa-table',
            'dashboardchart': 'fa-chart-bar',
        }
